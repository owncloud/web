            ...
            <template #filter>
              <div class="oc-flex oc-flex-middle oc-ml-m oc-mb-m oc-mt-m">
                ...
                <item-filter
                  ...
                  :items="groups"
                  :optionFilterPlaceholder="$gettext('Enter group name')"
                  :optionFilterLabel="$gettext('Filter groups')"
                  :show-filter="true"
                  class="oc-mr-s"
                ...
                <item-filter
                  ...
                  :filterable-attributes="['displayName']"
                  :items="roles"
                  :optionFilterPlaceholder="$gettext('Enter role name')"
                  :optionFilterLabel="$gettext('Filter roles')"
                  :show-filter="true"
                  display-name-attribute="displayName"
                  filter-name="roles"
