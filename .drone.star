config = {
	...
	'acceptance': {
		'webUI': {
			'suites': {
                'webUISharingPublicDifferentRoles1': ['SharingPublicDifferentRoles'],
                'webUISharingPublicDifferentRoles2': ['SharingPublicDifferentRoles'],
                'webUISharingPublicDifferentRoles3': ['SharingPublicDifferentRoles'],
                'webUISharingPublicDifferentRoles4': ['SharingPublicDifferentRoles'],
                'webUISharingPublicDifferentRoles5': ['SharingPublicDifferentRoles'],
                'webUISharingPublicDifferentRoles6': ['SharingPublicDifferentRoles'],
                'webUISharingPublicDifferentRoles7': ['SharingPublicDifferentRoles'],
                'webUISharingPublicDifferentRoles8': ['SharingPublicDifferentRoles'],
                'webUISharingPublicDifferentRoles9': ['SharingPublicDifferentRoles'],
