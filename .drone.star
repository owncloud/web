config = {
	...
	'acceptance': {
		'webUI-ocis': {
			'suites': {
				'webUISharingInternalGroups0': ['webUISharingInternalGroups',],
				'webUISharingInternalGroups1': ['webUISharingInternalGroups',],
				'webUISharingInternalGroups2': ['webUISharingInternalGroups',],
				'webUISharingInternalGroups3': ['webUISharingInternalGroups',],
				'webUISharingInternalGroups4': ['webUISharingInternalGroups',],
				'webUISharingInternalGroups5': ['webUISharingInternalGroups',],
				'webUISharingInternalGroups6': ['webUISharingInternalGroups',],
				'webUISharingInternalGroups7': ['webUISharingInternalGroups',],
				'webUISharingInternalGroups8': ['webUISharingInternalGroups',],
				'webUISharingInternalGroups9': ['webUISharingInternalGroups',],
			},
			'extraEnvironment': {
