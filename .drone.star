config = {
	...
	'acceptance': {
		'webUI': {
			'suites': {
				'SharingInternalGroupsRootSharingIndicator0': ['webUISharingInternalGroupsToRootSharingIndicator'] ,
				'SharingInternalGroupsRootSharingIndicator1': ['webUISharingInternalGroupsToRootSharingIndicator'] ,
				'SharingInternalGroupsRootSharingIndicator2': ['webUISharingInternalGroupsToRootSharingIndicator'] ,
				'SharingInternalGroupsRootSharingIndicator3': ['webUISharingInternalGroupsToRootSharingIndicator'] ,
				'SharingInternalGroupsRootSharingIndicator4': ['webUISharingInternalGroupsToRootSharingIndicator'] ,
				'SharingInternalGroupsRootSharingIndicator5': ['webUISharingInternalGroupsToRootSharingIndicator'] ,
				'SharingInternalGroupsRootSharingIndicator6': ['webUISharingInternalGroupsToRootSharingIndicator'] ,
				'SharingInternalGroupsRootSharingIndicator7': ['webUISharingInternalGroupsToRootSharingIndicator'] ,
				'SharingInternalGroupsRootSharingIndicator8': ['webUISharingInternalGroupsToRootSharingIndicator'] ,
				'SharingInternalGroupsRootSharingIndicator9': ['webUISharingInternalGroupsToRootSharingIndicator'] ,
			},
			'extraEnvironment': {
