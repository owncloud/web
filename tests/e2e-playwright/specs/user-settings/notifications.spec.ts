...
test.describe('Notifications', () => {
  ...
  test('user should be able to read and dismiss notifications', async () => {
    ...
    await api.deleteGroup({ usersEnvironment, stepUser: 'Admin', name: 'sales' })
  })
  ...
  test('user should not get any notification when notification is disabled', async () => {
    ...
    await ui.openUserMenu({ actorsEnvironment, stepUser: 'Brian' })
    ...
    await ui.openUserMenu({ actorsEnvironment, stepUser: 'Carol' })
