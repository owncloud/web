...
test.describe('file action - copy/move', { tag: '@predefined-users' }, () => {
  ...
  test('Users can copy a file from one folder to another', async () => {
    ...
    await ui.userShouldSeeTheResources({
      ...
      listType: 'files list',
      stepUser: 'Alice',
      resources: ['duplicate (1).txt']
    })
    await ui.userShouldSeeTheResources({
      actorsEnvironment,
      listType: 'files list',
      stepUser: 'Alice',
      resources: ['Duplicate (1)']
    })
    ...
    await ui.userShouldSeeTheResources({
      ...
      listType: 'files list',
      stepUser: 'Alice',
      resources: ['duplicate (2).txt']
    })
    await ui.userShouldSeeTheResources({
      actorsEnvironment,
      listType: 'files list',
      stepUser: 'Alice',
      resources: ['duplicate (3).txt']
    })
    await ui.userShouldSeeTheResources({
      actorsEnvironment,
      listType: 'files list',
      stepUser: 'Alice',
      resources: ['folderToDuplicate (1)']
    })
    await ui.userShouldSeeTheResources({
      actorsEnvironment,
      listType: 'files list',
      stepUser: 'Alice',
      resources: ['folderToDuplicate (2)']
    })
    ...
    await ui.userCopiesOrMovesResources({
      actorsEnvironment,
      stepUser: 'Alice',
      actionType: 'copies',
      method: 'sidebar-panel',
