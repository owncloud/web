...
const createNewPasswordProtectedFolderButton = '.new-file-btn-psec'
...
export const createPasswordProtectedFolder = async ({
  ...
  await page.locator(createNewPasswordProtectedFolderButton).click()
...
export const createNewFileOrFolder = async (args: createResourceArgs): Promise<void> => {
  ...
  switch (type) {
    ...
    case 'Password Protected Folder': {
      await createPasswordProtectedFolder({ page, resource: name, password })
      break
    }
    case 'txtFile': {
