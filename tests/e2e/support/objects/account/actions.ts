...
const notificationEventCheckBox = '//div[contains(@class, "account-table")]//h2[text()="Notifications"]//following-sibling::table//tr//td[text()="%s"]//following-sibling::td//span//input[@aria-label="In-App"]'
