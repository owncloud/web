Feature: users management
  ...
  Scenario: user login can be managed in the admin settings
    ...
    # adds users to group
    And "Admin" navigates to the users management page
    When "Admin" adds the user "bob" to the groups "sales,security" using the sidebar panel
    ...
    # Then "Admin" should see the following account page title "Konto"
    And "Admin" logs out
    ...
    And "Bob" edits the public link named "spaceLink" of the space changing role to "Can edit"
