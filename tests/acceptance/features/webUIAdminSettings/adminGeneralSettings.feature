@mailhog @admin_settings-feature-required
Feature: admin general settings
  ...
  @smokeTest @skipOnFIREFOX @skipOnDockerContainerTesting @issue-5015
  ...
  @smokeTest @skipOnDockerContainerTesting @issue-5015
