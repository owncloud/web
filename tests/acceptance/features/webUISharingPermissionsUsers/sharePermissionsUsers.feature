...
Feature: Sharing files and folders with internal users with different permissions
  ...
  Scenario: Change permissions of the previously shared folder
    ...
    When the user sets custom permission for current role of collaborator "Alice Hansen" for folder "simple-folder" to "create" using the webUI
    Then custom permissions "create, update" should be set for user "Alice Hansen" for folder "simple-folder" on the webUI
  ...
  #   And user "Alice" has accepted the share "lorem.txt" offered by user "Brian"
  #   And user "Brian" has logged in using the webUI
  #   Then no custom permissions should be set for collaborator "Alice Hansen" for file "lorem.txt" on the webUI
  #   When the user sets custom permission for current role of collaborator "Alice Hansen" for file "lorem.txt" to "share" using the webUI
  #   Then custom permission "share" should be set for user "Alice Hansen" for file "lorem.txt" on the webUI
  #   And user "Alice" should have received a share with these details:
  #     | field       | value         |
  #     | uid_owner   | Brian         |
  #     | share_with  | Alice         |
  ...
  #   Given user "Brian" has shared file "lorem.txt" with user "Alice" with "read, share" permissions
  #   And user "Alice" has accepted the share "lorem.txt" offered by user "Brian"
  #   And user "Brian" has logged in using the webUI
  #   Then custom permissions "share" should be set for user "Alice Hansen" for file "lorem.txt" on the webUI
  #   When the user disables all the custom permissions of collaborator "Alice Hansen" for file "lorem.txt" using the webUI
  #   Then no custom permissions should be set for collaborator "Alice Hansen" for file "lorem.txt" on the webUI
  #   And user "Alice" should have received a share with these details:
  #     | field       | value      |
  #     | uid_owner   | Brian      |
