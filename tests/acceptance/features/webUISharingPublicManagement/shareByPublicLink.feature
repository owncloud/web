...
Feature: Public link share management
  ...
  Scenario: sharing details of indirect items inside a shared folder
    ...
    And user "Alice" has logged in using the webUI
    When the user opens folder "simple-folder" using the webUI
    Then a link named "Public Link" should be listed with role "Can view" in the public link list of resource "sub-folder" via "simple-folder" on the webUI
  ...
  Scenario: sharing details of multiple indirect public link shares
    ...
    Then a link named "Public Link" should be listed with role "Can view" in the public link list of resource "textfile.txt" via "simple-folder" on the webUI
    And a link named "strängé लिंक नाम (#2 &).नेपाली" should be listed with role "Can view" in the public link list of resource "textfile.txt" via "sub-folder" on the webUI
  ...
  Scenario: sharing details of indirect link share in "favorites" file lists
    ...
    And user "Alice" has logged in using the webUI
    When the user browses to the shared-via-link page using the webUI
    Then a link named "Public Link" should be listed with role "Can view" in the public link list of resource "simple-folder/simple-empty-folder" via "simple-folder" on the webUI
    And a link named "Public Link Sub" should be listed with role "Can view" in the public link list of resource "simple-empty-folder" on the webUI
