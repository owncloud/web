...
#    Then the file "sampleWebm.webm" should be displayed in the media viewer webUI
  ...
  Scenario: preview of image files with extensions in UpperCase with media viewer
    ...
    And user "Alice" has logged in using the webUI
    When the user browses to the files page
    Then the preview image of file "testavatar.PNG" should be displayed in the file list view on the webUI
    When the user views the file "testavatar.PNG" in the media viewer by clicking on the file name using the webUI
