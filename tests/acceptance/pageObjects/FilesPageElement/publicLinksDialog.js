...
module.exports = {
  commands: {
    ...
    isExpiryDateDisabled: async function (linkName, pastDate) {
      ...
      const yearSelector = this.api.page.FilesPageElement
        .publicLinksCreationForm()
        .setExpiryDateYearSelectorXpath(year)
      const monthSelector = this.api.page.FilesPageElement
        .publicLinksCreationForm()
        .setExpiryDateMonthSelectorXpath(month)
      const daySelector = this.api.page.FilesPageElement
        .publicLinksCreationForm()
        .setExpiryDateDaySelectorXpath(iDay)
      await this
        .initAjaxCounters()
        .waitForElementVisible(this.api.page.FilesPageElement
          .publicLinksCreationForm()
          .elements.linkExpirationDateField.selector)
        .click(this.api.page.FilesPageElement
          .publicLinksCreationForm()
          .elements.linkExpirationDateField.selector)
        .waitForElementVisible(this.api.page.FilesPageElement
          .publicLinksCreationForm()
          .elements.dateTimePopupYear.selector)
        .waitForAnimationToFinish()
        .waitForElementEnabled(
          this.api.page.FilesPageElement
            .publicLinksCreationForm()
            .elements.dateTimePopupYear.selector
        )
        .angryClick(this.api.page.FilesPageElement
          .publicLinksCreationForm()
          .elements.dateTimePopupYear.selector)
