...
When('the user/public views the file {string} in the media viewer using the webUI', function(
  fileName
) {
...
Then('the file {string} should not be displayed in the media viewer webUI', async function(
  fileName
) {
